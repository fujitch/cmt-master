...
for i in [1,2,3,4]:
    for k in [1,2,3,4,5,6]:
        filename = 'sample_data\\mis1_p' + str(i) + '_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
        sound = []
        for j in range(23):
...
for i in [1,2,3,4]:
    for k in [1,2,3,4,5,6]:
        filename = 'sample_data\\mis1_p' + str(i) + '_n_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
        sound = []
        for j in range(23):
...
for i in [1,2,3,4]:
    ...
    for k in [7,8,9,10]:
        if k == 10:
            filename = 'sample_data\\inner2_p' + str(i) + '_00' + str(k) + '.csv'
        else:
            filename = 'sample_data\\inner2_p' + str(i) + '_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
...
for i in [1,2,3,4]:
    for k in [7,8,9,10]:
        if k == 10:
            filename = 'sample_data\\mis1_p' + str(i) + '_00' + str(k) + '.csv'
        else:
            filename = 'sample_data\\mis1_p' + str(i) + '_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
    ...
    for k in [7,8,9,10]:
        if k == 10:
            filename = 'sample_data\\mis2_p' + str(i) + '_00' + str(k) + '.csv'
        else:
            filename = 'sample_data\\mis2_p' + str(i) + '_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
...
for i in [1,2,3,4]:
    for k in [7,8,9,10]:
        if k == 10:
            filename = 'sample_data\\mis1_p' + str(i) + '_n_00' + str(k) + '.csv'
        else:
            filename = 'sample_data\\mis1_p' + str(i) + '_n_000' + str(k) + '.csv'
        file = open(filename, 'r')
        dataReader = csv.reader(file, delimiter='\t')
...
pickle.dump(train_dataset, open('train_dataset_0822.pkl', 'wb'))
pickle.dump(test_dataset, open('test_dataset_0822.pkl', 'wb'))